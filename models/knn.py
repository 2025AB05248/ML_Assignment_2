...
RESULTS_PATH = Path(__file__).resolve().parents[0] / "knn_results.json"
...
def train_and_evaluate(X, y, random_state=42, n_neighbors=5):
    ...
    y_prob = None
    try:
        # some KNN implementations provide predict_proba

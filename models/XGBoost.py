...
RESULTS_PATH = Path(__file__).resolve().parents[0] / "XGBoost_results.json"
...
def train_and_evaluate(X, y, random_state=42, n_estimators=100):
	...
	model = XGBClassifier(n_estimators=n_estimators, use_label_encoder=False, eval_metric='logloss', random_state=random_state)

...
RESULTS_PATH = Path(__file__).resolve().parents[0] / "logistic_results.json"
...
def train_and_evaluate(X, y, random_state=42):
	...
	# find numeric columns in X (after one-hot they remain numeric)
	# we'll scale columns that have more than 2 unique values as a heuristic
